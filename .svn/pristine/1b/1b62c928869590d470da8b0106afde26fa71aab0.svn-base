...
public class BapLogger implements BAPListener{
    ...
    protected double LB;
    protected AbstractBranchAndPrice bap;
     ...
     */
    public BapLogger(AbstractBranchAndPrice branchAndPrice, File outputFile){
        try {
    ...
    protected void constructAndWriteLine(){
        this.writeLine(String.valueOf(bapNodeID) + "\t" + parentNodeID + "\t" + objectiveIncumbentSolution + "\t" + nodeBound + "\t" + formatter.format(nodeValue) + "\t" + cgIterations + "\t" + timeSolvingMaster + "\t" + timeSolvingPricing + "\t" + nrGeneratedColumns + "\t" + nodeStatus + "\t" + nodesInQueue + "\t" + LB);
    }

    @Override
    public void startBAP(StartEvent startEvent) {
        this.writeLine("BAPNodeID \t parentNodeID \t objectiveIncumbentSolution \t nodeBound \t nodeValue \t cgIterations \t t_master \t t_pricing \t nrGenColumns \t solutionStatus \t nodesInQueue \t LB");
    }
