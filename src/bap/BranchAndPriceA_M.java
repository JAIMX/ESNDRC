...
//              subCutHandler.addCutGenerator(subCutGen);
              ...
              //Create a Branch-and-Price instance
                BranchAndPriceA_M subBap=new BranchAndPriceA_M(subGraph, subMaster, subPricingProblems, subSolvers, branchCreators,this.objectiveIncumbentSolution,0.6,0.3,0.1,20,0.5,5,0.1,false,true);
