...
public final class StrongInequalityGenerator extends AbstractCutGenerator<SNDRC, SNDRCMasterData> {
    ...
    public List<AbstractInequality> generateInqualities() {
        ...
        // "+masterData.edgeValueMap.get(edgeIndex));
        // if(masterData.edgeValueMap.get(edgeIndex)<1) {
        // for(int commodity=0;commodity<dataModel.numDemand;commodity++) {
        // System.out.println("x"+commodity+","+edgeIndex+"=
        // "+masterData.xValues.get(commodity).get(edgeIndex)+"
        // demandVolumn="+dataModel.demandSet.get(commodity).volume);
        // }
        // }
        // System.out.println();
        // }
        ...
        //
        // if (xValue > demandValue * edgeValue+0.1) {
        // StrongInequality inequality = new StrongInequality(this, edgeIndex,
        // commodity);
        // this.addCut(inequality);
        ...
        if (ifOnlyOneCut == 0) { // we add cuts for all commodities
    ...
    private void addCut(StrongInequality strongInequality) {
        ...
        try {
            ...
            // expr.addTerm(-dataModel.demandSet.get(strongInequality.commodity).volume,
            // var);
            // }
            // }
