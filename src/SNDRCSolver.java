...
//							.doubleToInt(xValues.get(edgeIndex));
		...
		System.out.println("size0= " + serviceEdgeSet0.size() + " size1= " + keyServiceEdgeIndexSet.size()
				+ " # of common edges= " + commonCount);
		...
		System.out.println("size of pattrenSet0= " + pattern0.size() + " size of patternSet1= "
				+ avoidRepeatPattern.size() + " # of common patterns= " + commonCount);
